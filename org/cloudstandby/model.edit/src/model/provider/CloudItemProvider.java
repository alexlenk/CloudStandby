...
/**
 * This is the item provider adapter for a {@link model.Cloud} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CloudItemProvider
	...
	protected void addLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cloud_location_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cloud_location_feature", "_UI_Cloud_type"),
				 ModelPackage.Literals.CLOUD__LOCATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addProviderIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cloud_providerId_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cloud_providerId_feature", "_UI_Cloud_type"),
				 ModelPackage.Literals.CLOUD__PROVIDER_ID,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPublicKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cloud_publicKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cloud_publicKey_feature", "_UI_Cloud_type"),
				 ModelPackage.Literals.CLOUD__PUBLIC_KEY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addPrivateKeyPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cloud_privateKey_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cloud_privateKey_feature", "_UI_Cloud_type"),
				 ModelPackage.Literals.CLOUD__PRIVATE_KEY,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public Collection getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(ModelPackage.Literals.CLOUD__STANDARD_IMAGE);
			childrenFeatures.add(ModelPackage.Literals.CLOUD__VIRTUAL_MACHINE);
		}
	...
	protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.CLOUD__STANDARD_IMAGE,
				 ModelFactory.eINSTANCE.createStandardImage()));

		newChildDescriptors.add
			(createChildParameter
				(ModelPackage.Literals.CLOUD__VIRTUAL_MACHINE,
				 ModelFactory.eINSTANCE.createVirtualMachine()));
	}
